...
**Wave-0 stop condition:** both gates pass; commit in `MNL/` with the gate artifacts. Only then does Wave 1 begin. **Status: 0.1 DONE (verify-only, R3 premise corrected); 0.2 (Box-Cox) is next.**
